...
The derivation of these both expressions for $V$ is given in \Cref{m-electron-operators-ordinary-and-antisymmetrized}.
In KM notation, we write \Cref{m-electron-operator-expressions} as
\begin{align}
&&
  V
=
...
\begin{ntt}
\thmtitle{Diagram representation of $m$-electron operators: Goldstone and Hugenholtz}
